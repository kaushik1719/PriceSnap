...
export async function addProduct(formData){
    ...
    try 
    {
        ...
        if(!productData.productName || !productData.currentPrice)
        {
          ...
          return {error: "Could not extract product information friom this URL"};
        } 

        const newPrice = parseFloat(productData.currentPrice);
        const currency = productData.currencyCode || "USD";

        //  if product already exist then simply uodate the product
        ...
        revalidatePath("/"); // Revalidate home page to show new product
...
export async function deleteProduct(productId){
    try {
        ...
        revalidatePath("/"); // Revalidate home page to reflect deletion
        return {success: true};
    }
    catch (error){
